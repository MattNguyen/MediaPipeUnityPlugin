...
public class PlayerManager : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        motionTransfer.tgtFace = playerAvatar.transform.Find("Renderer_Head").GetComponent<SkinnedMeshRenderer>();
        motionTransfer.tgtTeeth = playerAvatar.transform.Find("Renderer_Teeth").GetComponent<SkinnedMeshRenderer>();
    }
}
