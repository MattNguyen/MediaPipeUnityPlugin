...
public class NetworkPlayer : MonoBehaviourPun, IPunObservable, IPunInstantiateMagicCallback
{
    ...
    void Start()
    {
        ...
        srcFace = templateAvatar.transform.Find("Renderer_Head").GetComponent<SkinnedMeshRenderer>();
    ...
    private void OnAvatarLoaded(object sender, CompletionEventArgs args)
    {
        ...
        tgtFace = avatar.transform.Find("Renderer_Head").GetComponent<SkinnedMeshRenderer>();
        tgtTeeth = avatar.transform.Find("Renderer_Teeth").GetComponent<SkinnedMeshRenderer>();
